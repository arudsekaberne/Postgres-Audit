...
class Vault:
    ...
    SMTP_RECEIVERS: List[str] = ["arudsekaberne.project@gmail.com"]
    ...
    def send_email_notification(cls, batch_run_datetime: datetime, batch_type: str, expection: Optional[Exception] = None) -> None:
        ...
        Outlook.send(
            ...
            subject = f"{'TEST' if Environment.is_dev() else 'LIVE'} [PgAudit] {'❌' if expection else '✅'} MGDB Database Log Inc Load",
