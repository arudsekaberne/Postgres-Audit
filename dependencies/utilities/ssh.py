...
class SSHConnection:
    ...
    # Class Variable
    DOCKER_USERNAME  : Final[str] = "root"
    DOCKER_CONTAINER : Final[str] = "postgres"
    ...
    def execute_psql(self, sql_statement: str) -> str:
        ...
        exec_command: str = f"sudo docker exec -u {self.DOCKER_USERNAME} {self.DOCKER_CONTAINER} psql 'postgresql://{db_username}@localhost/{db_database}?application_name={self.APPLICATION_NAME}' -c '{sql_statement}'"
        ...
        print(f"  - [DONE] ({elapsed_time:.6f}) seconds")
